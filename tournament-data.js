...
const groupMatches = {
    ...
    groupC: {
        teams: [
            { name: "złotówka team", record: "1-0", games: "3-0", points: 3 },
            { name: "team overdrive", record: "1-0", games: "3-0", points: 3 },
            { name: "Aero Esport", record: "0-1", games: "0-3", points: -3 },
            { name: "fc nikt nas nie chce", record: "0-1", games: "0-3", points: -3 }
        ],
        matches: [
